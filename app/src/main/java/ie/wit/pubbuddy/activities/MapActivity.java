...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mLocationPermissionsGranted) {
            ...
            //If permission granted, initialize init method
            init();
        ...
        mSearchText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int actionId, KeyEvent keyEvent) {
                if(actionId == EditorInfo.IME_ACTION_SEARCH
                        ...
                        || keyEvent.getAction() == KeyEvent.KEYCODE_0
        ...
        switch(requestCode){
            case LOCATION_PERMISSION_REQUEST_CODE:{
                if(grantResults.length > 0){
                    for(int i = 0; i < grantResults.length; i++){ //For loop because we are checking for more than one permission
                    ...
                    //If all permissions are granted, initialize map
                    initMap();
                }
            }
        }
